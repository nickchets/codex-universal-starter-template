...
2) Задай мне стартовые вопросы из docs/AGENT_STARTUP_QUESTIONNAIRE.ru.md.
3) Заполни/обнови PROJECT_MANIFEST.md, ACTION_PLAN.md, docs/DIRECTIVE_REGISTER.md.
4) Подтверди инварианты доски (DOING==1, NEXT<=3).
